...
public class Operations {
  ...
  public double evaluateVerbose(String expression) {
    String postfix_expression = infix2postfixVerbose(expression);
    return evaluatePostFixVerbose(postfix_expression);
  }

  public double evaluatePostFixVerbose(String postfix_expression) {
    String[] postfix_expression_arr = postfix_expression.split(" ");
    Stack<Double> stk = new Stack<Double>();
  ...
  public String infix2postfixVerbose(String infix_expression) {
    Stack<String> output = new Stack<String>();
    Stack<String> stk = new Stack<String>();
    String[] infix_expression_arr = infix_expression.split(" ");
    for (String token : infix_expression_arr) {
